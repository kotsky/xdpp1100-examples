 ...
 */
PMBUS_CMD_t PMBUS_CMD_MFR_Hallo_Welt;
uint8_t	PMBUS_CMD_MFR_Hallo_Welt_DATA_LOOP0[1];  	// data array for command loop0
uint8_t	PMBUS_CMD_MFR_Hallo_Welt_DATA_LOOP1[1];    // data array for command loop1 (pointer if common)
...
void pmbus_mfr_autogen_init(void)
{
	...
	//PMBUS_CMD_MFR_Hallo_Welt.OPCODE = PMBUS_CMDCODE_MFR_Hallo_Welt;
	//PMBUS_CMD_MFR_Hallo_Welt.WRITE_PROTOCOL = (uint8_t) TRANSACTION_PROTOCOL_WRITE;
	//PMBUS_CMD_MFR_Hallo_Welt.READ_PROTOCOL = (uint8_t) TRANSACTION_PROTOCOL_READ;
	//PMBUS_CMD_MFR_Hallo_Welt.NUM_BYTES = 1; // data only not including slave address and command
