...
typedef struct {
	...
	int8_t   vin_thresh_exponent[NUM_LOOPS];
	uint16_t fsw_target[NUM_LOOPS];			// format u11.0
	int8_t fsw_exp[NUM_LOOPS];
	uint16_t vin_threshold[NUM_LOOPS];
	uint16_t vin_hysteresis_threshold[NUM_LOOPS];
